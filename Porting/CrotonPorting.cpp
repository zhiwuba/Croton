...
//thread function.
handle_thread thread_create(void* security, unsigned stack_size, COOL_THREAD_FUN start_address, void* arglist, unsigned initflag /*= 0*/, unsigned* thraddr /*= NULL*/)
{
	pthread_attr_t attr;
